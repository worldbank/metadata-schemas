...
#   timestamp: 2024-07-02T17:29:18+00:00
...
class TemporalElementItem(SchemaBaseModel):
...
class Extent(SchemaBaseModel):
    ...
    temporalElement: Optional[List[TemporalElementItem]] = Field(None, title="Temporal extent(s)")
...
class SpatialResolution(SchemaBaseModel):
    """
    Spatial resolution of the resource
    """
...
class Identifier(SchemaBaseModel):
    """
    Unique identifier for the resource metadata
    """
...
class Citation(SchemaBaseModel):
    ...
    alternateTitle: Optional[str] = Field(None, description="Resource alternate title", title="Alternate Title")
    ...
    identifier: Optional[Identifier] = Field(
        None, description="Unique identifier for the resource metadata", title="Identifier"
    )
    ...
    presentationForm: Optional[List[str]] = Field(
        None,
        description=(
...
class IdentificationInfoItem(SchemaBaseModel):
    ...
    spatialRepresentationType: Optional[str] = Field(
        None,
        description=(
    ...
    spatialResolution: Optional[SpatialResolution] = Field(
...
class Description(SchemaBaseModel):
    ...
    hierarchyLevel: Optional[List[str]] = Field(
        None,
        description=(
    ...
    hierarchyLevelName: Optional[List[str]] = Field(
        None,
    ...
    identificationInfo: Optional[List[IdentificationInfoItem]] = Field(
...
class GeospatialSchema(SchemaBaseModel):
    ...
    published: Optional[int] = Field(0, description="Status of the dataset - 0=draft, 1=published")
    overwrite: Optional[Overwrite] = Field("no", description="Overwrite if already exists?")
