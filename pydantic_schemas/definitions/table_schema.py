...
#   timestamp: 2024-07-12T20:05:54+00:00
...
class AuthoringEntity(SchemaBaseModel):
    """
    The person, corporate body, or agency responsible for the work's substantive and intellectual content. Repeat the element for each author, and use 'affiliation' attribute if available. Invert first and last name and use commas.
    """

    __root__: List[AuthoringEntityItem] = Field(
        ...,
        description=(
...
class TableDescription(SchemaBaseModel):
    ...
    authoring_entity: Optional[AuthoringEntity] = Field(None, description="Authoring entity", title="Authoring entity")
    contributors: Optional[Contributor] = Field(None, description="Contributors", title="Contributors")
    ...
    keywords: Optional[Keyword] = Field(None, description="Keywords", title="Keywords")
