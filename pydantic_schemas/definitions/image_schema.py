...
#   timestamp: 2024-07-23T17:17:19+00:00
...
class AltLang(SchemaBaseModel):
    __root__: str = Field(..., description="Text in alternative languages")
...
class ArtworkOrObject(SchemaBaseModel):
    ...
    physicalDescription: Optional[AltLang] = Field(
        None,
        description=(
    ...
    contributionDescription: Optional[AltLang] = Field(
        None,
    ...
    copyrightNotice: Optional[AltLang] = Field(
        None,
        description=(
...
class CvTerm(SchemaBaseModel):
    ...
    cvTermName: Optional[AltLang] = Field(
        None,
...
class Entity(SchemaBaseModel):
    ...
    name: Optional[AltLang] = Field(None, description="Full name of the entity/concept", title="Name")
...
class EpisodeSeason(SchemaBaseModel):
    ...
    name: Optional[AltLang] = Field(None, description="Name of the episode or season of a series", title="Name")
...
class Location(SchemaBaseModel):
    ...
    provinceState: Optional[AltLang] = Field(
        None, description="Name of the state or province the Location is located in", title="State/Province name"
    )
    city: Optional[AltLang] = Field(None, description="Name of the city the Location is located in", title="City name")
    sublocation: Optional[AltLang] = Field(
...
class PersonWDetails(SchemaBaseModel):
    ...
    name: Optional[AltLang] = Field(None, description="Name of the person", title="Name")
    description: Optional[AltLang] = Field(None, description="A textual description of the person", title="Description")
    identifiers: Optional[List[AnyUrl]] = Field(
...
class Product(SchemaBaseModel):
    ...
    description: Optional[AltLang] = Field(
    ...
    name: Optional[AltLang] = Field(None, description="Name of the product.", title="Name {Product  detail}")
...
class ProductWGtin(SchemaBaseModel):
    ...
    name: Optional[AltLang] = Field(None, description="Name of the product.", title="Name")
    gtin: str = Field(
        ...,
        description="A 14 digit GTIN (Global Trade Item Number) of the product (GTIN-8 to GTIN-14 codes are used).",
        title="GTIN",
...
class Series(SchemaBaseModel):
    ...
    name: Optional[AltLang] = Field(None, description="Name of the series", title="Series name")
...
class PhotoVideoMetadataIPTC(SchemaBaseModel):
    ...
    usageTerms: Optional[AltLang] = Field(
